...
public class ArticleDetailFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // Toolbar toolbar = (Toolbar) mRootView.findViewById(R.id.main_toolbar);
        AppCompatActivity thisActivity = (AppCompatActivity)this.getActivity();
    ...
    private void updateStatusBar() {
        int color = 0;
        if (mPhotoView != null) {
            AppCompatActivity fragmentActivity = (AppCompatActivity) this.getActivity();
            final Window window = fragmentActivity.getWindow();

            color = Color.argb((int) (255 * 0.5),
        ...
        //mDrawInsetsFrameLayout.setInsetBackground(mStatusBarColorDrawable); //mad commented
    }
    ...
    private void bindViews() {
        ...
        if (mCursor != null) {
            ...
            TextView toolbar_textView = (TextView)mRootView.findViewById(R.id.toolbar_text_title);
            toolbar_textView.setText(title);
            toolbar_textView.setTypeface(robotoFont);
            ...
            bylineView.setText(Html.fromHtml(
                    DateUtils.getRelativeTimeSpanString(
                            ...
                            + "</font>"));
            Spanned htmlString = Html.fromHtml(mCursor.getString(ArticleLoader.Query.BODY));

            bodyView.setText(htmlString);
            bodyView.setTypeface(robotoRegularFont);
