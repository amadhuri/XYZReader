...
public class ArticleDetailActivity extends AppCompatActivity
    ...
    public final static String EXTRA_SELECT_ID = "EXTRA_SELECT_ID";
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // mUpButton = findViewById(R.id.action_up); //mad commented
        ...
        if (savedInstanceState == null) {
            ...
            mSelectedItemId = savedInstanceState.getLong(EXTRA_SELECT_ID);
        }
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putLong(EXTRA_SELECT_ID, mSelectedItemId);
    }
